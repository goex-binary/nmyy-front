  ...
  >
    <el-form :model="ruleForm" ref="addForm1" :rules="loginRules">
      ...
      <div class="a-form-item" style="height: auto">
        <label for="cameraCode">选择摄像头：</label>
        <div style="width: 100%">
...
<script>
import PlanTable from "./plan-table.vue";
import { deviceQuery } from "@/api/neimeng";
...
export default {
  ...
  data() {
    ...
    return {
      ...
      loading: false,
      loginRules: {
        cameraCode: [{ required: true, validator: validateRequired }],
  ...
  methods: {
    ...
    handleSel(list) {
      ...
      if (currentCarem) {
        this.ruleForm.cameraCode = currentCarem.cameraCode;
      } else {
        this.ruleForm.cameraCode = "";
      }
    },
    handleClose() {
