...
import RoleModifyDialog from './role-modify-dialog'
import RecordTable from './record-table.vue'
import { roleList, nodeList, deleteRole } from '@/api/user'
...
export default {
    ...
    methods: {
        ...
        initTable () {
            roleList({ roleName: this.keyword, page: this.currentPage, pageSize: this.pageSize }).then((res) => {
                if (res.code === "00000" && res.data) {
