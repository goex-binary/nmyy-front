<template>
    <el-dialog title="修改角色" width="670px" class="add-dialog" top="15vh" @open="handleOpen"
...
<script>
import { modifyRole } from '@/api/user'
...
export default {
    ...
    data () {
        ...
        return {
            ...
            formRules: {
                ...
                roleDesc: [{ required: true, validator: validateRequired }],
    ...
    methods: {
        ...
        handleOpen () {
            ...
            if (this.rowData?.permissions?.length) {
                let options = this.rowData.permissions;
                this.jurValue = options.map(item => {
                    return item.permId;
                });
            } else {
                this.jurValue = []
